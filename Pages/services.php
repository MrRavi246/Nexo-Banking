  ...
  <main>
      ...
      <div class="hero-content">
        <div class="hero-text">
          ...
          <p class="hero-subtitle">
            From personal banking to business solutions, discover our
            comprehensive range of financial services tailored to your needs
          </p>
      ...
      <div class="service-category personal-services active">
        <div class="services-grid">
          <div class="service-card featured">
            ...
            <p>
              High-yield accounts with no monthly fees and unlimited
              transactions
            </p>
          ...
          <div class="service-card">
            ...
            <h3>Home Loans</h3>
            <p>
              Competitive mortgage rates for first-time and experienced buyers
            </p>
            <ul class="service-features">
          ...
          <div class="service-card">
            ...
            <p>
              Comprehensive insurance coverage for life, health, and property
            </p>
            <ul class="service-features">
      ...
      <div class="service-category business-services">
        <div class="services-grid">
          ...
          <div class="service-card">
            ...
            <p>
              Flexible financing solutions for business growth and expansion
            </p>
            <ul class="service-features">
              <li>Term loans</li>
      ...
      <div class="support-content">
        <div class="support-text">
          ...
          <p>
            ...
            banking solution for your unique needs and goals.
          </p>
    ...
    <div class="cta-section">
      <div class="cta-content">
        ...
        <p>
          Open your account today and experience the difference of modern
          banking
        </p>
    ...
    document.addEventListener("DOMContentLoaded", function() {
      ...
      categoryCards.forEach((card) => {
        card.addEventListener("click", function() {
          ...
          document
            .querySelector(`.${category}-services`)
